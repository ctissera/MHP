...
--   Date and Time:   12:54 Lunes Diciembre 26, 2016
...
'No help is available for this page.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161222095911'
  );
null;
...
'and comobj.COMOBE_ESTADO in (''HAB'',''ANU'',''BAJ'')'||unistr('\000a')||
'/*';

s:=s||'and comobj.COMOBE_ID = (select max(comobe2.ID)'||unistr('\000a')||
...
wwv_flow_api.create_report_columns (
  ...
  p_column_link=>'f?p=&APP_ID.:268:&SESSION.::&DEBUG.:::',
...
'--       ,comode.ESTADO_DESC '||unistr('\000a')||
'       --,COMPRV_PKG.COMOBD_OBTN_ESTADO(comode.segorg_id,comode.COMOBJ_COMPRV_ID,comode.ID ,comode.comobj_ID) ESTADO_DESC'||unistr('\000a')||
'        ,COMPRV_PKG.COMOBD_PRESENTADO_SN3(comode.segorg_id,comode.COMOBJ_COMPRV_ID,comode.ID ,comode.comobj_ID) ESTADO_DESC'||unistr('\000a')||
'       ,''<a hr';

s:=s||'ef="f?p=&APP_ID.:933:&SESSION.::&DEBUG.:933:P933_COMPRV_ID,P933_COMRUB_ID,P933_COMODT_ID,P933_COMOBJ_ID,P933_COMOBJ_SN,G_APP_ANTERIOR,G_APP_ANTERIOR_PAG:''||:P268_COMPRV_ID||'',''||:P268_COMRUB_ID||'',''||comode.ID||'',''||comode.COMOBJ_ID||'',SI''||'',''||:APP_ID||'',''||:APP_PAGE_ID||''">Presentar</a>'' PRESENTAR'||unistr('\000a')||
'       ,null DESCARGA'||unistr('\000a')||
'       ,null ID'||unistr('\000a')||
'from   COM_OBJETOS_DOC_ESTADO_V2 comode'||unistr('\000a')||
'where  comode.COMOBJ';

s:=s||'_COMPRV_ID = :P268_COMPRV_ID'||unistr('\000a')||
...
s:=s||'   where  comodt.ID = comobd.COMODT_ID) DOCUMENTO'||unistr('\000a')||
...
s:=s||'                                     from   COM_OBJETOS_OTT comott'||unistr('\000a')||
...
s:=s||'    /*,comprv_pkg.comobd_obtn_estado(p_segorg_id      => comobj.segorg_id'||unistr('\000a')||
'                                   ,p_comprv_id      => comobj.comprv_id'||unistr('\000a')||
'                                   ,p_comodt_id      => comobd.comodt_id'||unistr('\000a')||
'                                   ,p_comobj_id      => comobj.ID) ESTADO_DESC  */ '||unistr('\000a')||
'      ,COMPRV_PKG.COMOBD_PRESENTADO_SN3(comobj.segorg_id,comobj.COMPRV_ID,comobd.comodt_id ,como';

s:=s||'bj.ID) ESTADO_DESC                                                    '||unistr('\000a')||
'      ,''<a href="f?p=&APP_ID.:933:&SESSION.::&DEBUG.:933:P933_COMPRV_ID,P933_COMRUB_ID,P933_COMODT_ID,P933_COMOBJ_ID,P933_COMOBJ_SN,G_APP_ANTERIOR,G_APP_ANTERIOR_PAG:''||:P268_COMPRV_ID||'',''||:P268_COMRUB_ID||'',''||comobd.COMODT_ID||'',''||comobd.COMOBJ_ID||'',SI''||'',''||:APP_ID||'',''||:APP_PAGE_ID||''">Presentar</a>'' PRESENTAR        ';
...
s:=s||'D =comprv_pkg.comobd_presentado_sn2 (comobj.segorg_id,'||unistr('\000a')||
...
s:=s||'                                      comobj.ID) not in (''PRESENTADO'', ''NO PRESENTADO'')'||unistr('\000a')||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 36100809703290764 + wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 36106616757895320 + wwv_flow_api.g_id_offset,
  p_region_id=> 32483616209416031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365906308228634793 + wwv_flow_api.g_id_offset,
  p_region_id=> 32483616209416031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
  p_column_alias=> 'ESTADO_DESC',
  p_column_display_sequence=> 13,
  p_column_heading=> 'Estado ',
  p_use_as_row_header=> 'N',
  p_column_alignment=>'LEFT',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 32664106883743576 + wwv_flow_api.g_id_offset,
  p_region_id=> 32483616209416031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 36096013647213035 + wwv_flow_api.g_id_offset,
  p_region_id=> 32483616209416031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
