...
--   Date and Time:   13:30 Jueves Diciembre 1, 2016
...
'}'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161201132852'
  );
null;
...
'from CFG_PORTAL_PAGDIA2_V'||unistr('\000a')||
...
wwv_flow_api.create_page_plug (
  ...
  p_plug_display_when_condition => 'select 1 from CFG_PORTAL_PAGDIA2_V'||unistr('\000a')||
' where CFGPOP_ID =  :P2_CFGPOP_POR_ID'||unistr('\000a')||
'   and CFGDIA_SITUACION = ''APR'''||unistr('\000a')||
'   and SITUACION = ''PUB'''||unistr('\000a')||
'   and sysdate between nvl(PUBLICACION_DESDE,sysdate) and nvl (PUBLICACION_HASTA,sysdate)'||unistr('\000a')||
...
'    from CFG_PORTAL_PAGENL2_V'||unistr('\000a')||
'   where CFGPOP_ID =  :P2_CFGPOP_POR_ID'||unistr('\000a')||
'     and S';

s:=s||'ITUACION = ''PUB'''||unistr('\000a')||
...
'  where segorg_id = :p1_sego';

s:=s||'rg_id;'||unistr('\000a')||
...
s:=s||'urado, el servicio no esta habilitado'||unistr('\000a')||
...
'        htp.print(''<br><br>No existen Nove';

s:=s||'dades Etiquetadas Recientemente ... <br><br>'');'||unistr('\000a')||
'      end if;'||unistr('\000a')||
'    end if;'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'end;';
...
'  select *'||unistr('\000a')||
'  from not_configuraciones'||unistr('\000a')||
'  where segorg_id = :p1_s';

s:=s||'egorg_id;'||unistr('\000a')||
'  -- Para obtener las novedades a publicar'||unistr('\000a')||
'  cursor cr_notnov is'||unistr('\000a')||
'  select *'||unistr('\000a')||
'  from not_novedades'||unistr('\000a')||
...
'  --'||unistr('\000a')||
'begin'||unistr('\000a')||
'  -- Si se muestran los mensajes de Cuer';
...
'      -- Si no existen novedades para publicar'||unistr('\000a')||
'      if i = 0 then'||unistr('\000a')||
'        htp.print(''<br><br>No existen N';

s:=s||'ovedades Etiquetadas Recientemente ... <br><br>'');'||unistr('\000a')||
'      end if;'||unistr('\000a')||
'    end if;'||unistr('\000a')||
'  end if;'||unistr('\000a')||
'end;';
...
'  ,CODIGO'||unistr('\000a')||
'  ,TITULO'||unistr('\000a')||
'  from CFG_PORTAL_PAG2_V'||unistr('\000a')||
'  where segorg_id = :P1_SEGORG_ID'||unistr('\000a')||
...
p:=p||'TITULO_PORTAL     := null;'||unistr('\000a')||
...
p:=p||'SEC2_CODIGO := null; '||unistr('\000a')||
...
p:=p||'P_SEC8_CODIGO := null; '||unistr('\000a')||
...
p:=p||'R_CODIGO := v_cfgpop.CODIGO;'||unistr('\000a')||
...
p:=p||'EGIN :P1_CFGPOP_SEC1_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC1_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
...
'         when 4 then BEGIN :P1_CFGPOP_SEC4_CODIGO := v_cfgpop.COD';

p:=p||'IGO; :P1_CFGPOP_SEC4_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
...
'         when 7 then BEGIN :P1_CFGPOP_SEC7_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC7_TITULO := v_cfgpop.TIT';

p:=p||'ULO;  END;'||unistr('\000a')||
...
'    :P1_CUERPO_MENSAJE_4    := v_cfgpop.CUERPO_MENSAJE_4;'||unistr('\000a')||
'    :P1_AUDIO_SN          := v_cfgpop.AUDIO_SN;'||unistr('\000a')||
'    :P1_AUDIO_ARCHIVO     := v_cfgpop';

p:=p||'.AUDIO_ARCHIVO;'||unistr('\000a')||
'    :P1_INTERVALO_SLIDE   := nvl(v_cfgpop.INTERVALO_SLIDE,15000);'||unistr('\000a')||
'  ELSIF v_cfgpop.TIPO IN (''PAG'',''ENL'') THEN'||unistr('\000a')||
'    CASE v_opciones '||unistr('\000a')||
...
p:=p||' then BEGIN :P1_CFGPOP_SEC3_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC3_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'         when 4 then BEGIN :P1_CFGPOP_SEC4_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC4_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'         when 5 then BEGIN :P1_CFGPOP_SEC5_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC5_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'         when 6 then BEGIN :P1_CFGPOP_SEC6_CODIGO := v_cfg';

p:=p||'pop.CODIGO; :P1_CFGPOP_SEC6_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'         when 7 then BEGIN :P1_CFGPOP_SEC7_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC7_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'         when 8 then BEGIN :P1_CFGPOP_SEC8_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC8_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'         when 9 then BEGIN :P1_CFGPOP_SEC9_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC9_TITULO := v_cfg';

p:=p||'pop.TITULO;  END;'||unistr('\000a')||
'         when 10 then BEGIN :P1_CFGPOP_SEC10_CODIGO := v_cfgpop.CODIGO; :P1_CFGPOP_SEC10_TITULO := v_cfgpop.TITULO;  END;'||unistr('\000a')||
'    END CASE;'||unistr('\000a')||
...
p:=p||'O_MENSAJE    := v_cfgpop.CUERPO_MENSAJE;'||unistr('\000a')||
...
'  end loop;'||unistr('\000a')||
'  -- Redireccionar si el tipo de ';

p:=p||'página es enlace y el enlace se encuentra configurado'||unistr('\000a')||
