...
'No help is available for this page.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170215135601'
  );
null;
...
'       ,''<a href="f?p=&APP_ID.:933:&SESSION.::&DEBUG.:933:P933_COMPRV_ID,P933_COMRUB_ID,P933_COMODT_ID,P933_C';

s:=s||'OMOBJ_ID,P933_COMOBJ_SN,G_APP_ANTERIOR,G_APP_ANTERIOR_PAG:''||:P268_COMPRV_ID||'',''||:P268_COMRUB_ID||'',''||comode.ID||'',''||comode.COMOBJ_ID||'',SI''||'',''||:APP_ID||'',''||:APP_PAGE_ID||''">Presentar</a>'' PRESENTAR'||unistr('\000a')||
'--,DBMS_LOB.GETLENGTH(COMOBD.DOCUMENTO) DESCARGA'||unistr('\000a')||
'  ,(select DBMS_LOB.GETLENGTH(DOCUMENTO) from COM_OBJETOS_DOC where id = comode.id) DESCARGA'||unistr('\000a')||
'from   COM_OBJETOS_DOC_ESTADO_V2 comode'||unistr('\000a')||
'       --,C';

s:=s||'OM_OBJETOS_DOC COMOBD'||unistr('\000a')||
'where  comode.COMOBJ_COMPRV_ID = :P268_COMPRV_ID'||unistr('\000a')||
'--and    COMOBD.id = comode.id'||unistr('\000a')||
'and    comode.COMOBJ_COMRUB_ID = :P268_COMRUB_ID'||unistr('\000a')||
...
s:=s||'mode.COMOTT_OBLIGATORIO_SN = ''NO'''||unistr('\000a')||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366142102716854835 + wwv_flow_api.g_id_offset,
  p_region_id=> 32483616209416031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366232314286429593 + wwv_flow_api.g_id_offset,
  p_region_id=> 32483616209416031 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
  p_column_alias=> 'DESCARGA',
  p_column_display_sequence=> 13,
  p_column_heading=> 'Descarga',
  p_use_as_row_header=> 'N',
  p_column_format=> 'DOWNLOAD:COM_OBJETOS_DOC:DOCUMENTO:ID::MIMETYPE:FILENAME:LAST_UPDATE_DATE::Attachment:Abrir Doc.',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'CENTER',
...
'from (select distinct '||unistr('\000a')||
'        comode.ID COMODT_ID'||unistr('\000a')||
'       ,comode.COMOBJ_ID'||unistr('\000a')||
'       ,comode.COMOBJ_COMPRV_ID COMPRV_ID'||unistr('\000a')||
'       ,comode.SEGORG_ID '||unistr('\000a')||
'       ,comode.NOMBRE DOCUMENTO'||unistr('\000a')||
'       ,comode.COMOBT_NOMBRE OBJETO'||unistr('\000a')||
'       ,comode.COMOBJ_CODIGO '||unistr('\000a')||
...
'       ,(select comrub.NOMBRE'||unistr('\000a')||
'        from   COM_RUBROS comrub'||unistr('\000a')||
'        where  comrub.ID = comode.COMOBJ_COMRUB_ID)||deco';

s:=s||'de(comode.COMOTT_OBLIGATORIO_SN,''SI'','' - <span style="color:red">(OBLIGATORIO)</span>'','' - (OPCIONAL)'') RUBRO'||unistr('\000a')||
'       ,comode.ESTADO_DESC ESTADO'||unistr('\000a')||
'       ,''<a href="f?p=&APP_ID.:933:&SESSION.::&DEBUG.:933:P933_COMPRV_ID,P933_COMRUB_ID,P933_COMODT_ID,P933_COMOBJ_ID,P933_COMOBJ_SN,G_APP_ANTERIOR,G_APP_ANTERIOR_PAG:''||:P268_COMPRV_ID||'',''||:P268_COMRUB_ID||'',''||comode.ID||'',''||comode.COMOBJ_ID||'',SI''||''';

s:=s||',''||:APP_ID||'',''||:APP_PAGE_ID||''">Presentar</a>'' PRESENTAR'||unistr('\000a')||
'       ,null DESCARGA'||unistr('\000a')||
'       ,null ID'||unistr('\000a')||
'from   COM_OBJETOS_DOC_ESTADO_V comode'||unistr('\000a')||
'where  comode.COMOBJ_COMPRV_ID = :P268_COMPRV_ID'||unistr('\000a')||
'and    comode.COMOBJ_COMRUB_ID = :P268_COMRUB_ID'||unistr('\000a')||
'and    comode.SEGORG_ID = :P1_SEGORG_ID'||unistr('\000a')||
'and    comode.ESTADO = ''NO PRESENTADO'''||unistr('\000a')||
'--'||unistr('\000a')||
'union all'||unistr('\000a')||
'--'||unistr('\000a')||
'select  comobd.COMODT_ID COMODT_ID'||unistr('\000a')||
...
s:=s||'       ,comobj.COMPRV_ID COMPRV_ID'||unistr('\000a')||
'       ,comobj.SEGORG_ID SEGORG_ID'||unistr('\000a')||
'       ,(select comodt.NOMBRE COMODT_NOMBRE'||unistr('\000a')||
'        from   COM_OBJETOS_DOT comodt'||unistr('\000a')||
'        where  comodt.ID = comobd.COMODT_ID) DOCUMENTO'||unistr('\000a')||
...
s:=s||'          ,p_comobj_id      => comobj.ID) ESTADO_DESC                                                       '||unistr('\000a')||
'      ,''<a href="f?p=&APP_ID.:933:&SESSION.::&DEBUG.:933:P933_COMPRV_ID,P933_COMRUB_ID,P933_COMODT_ID,P933_COMOBJ_ID,P933_COMOBJ_SN,G_APP_ANTERIOR,G_APP_ANTERIOR_PAG:''||:P268_COMPRV_ID||'',''||:P268_COMRUB_ID||'',''||comobd.COMODT_ID||'',''||comobd.COMOBJ_ID||'',SI''||'',''||:APP_ID||'',''||:APP_PAGE_I';

s:=s||'D||''">Presentar</a>'' PRESENTAR                                                       '||unistr('\000a')||
'      ,DBMS_LOB.GETLENGTH(comobd.DOCUMENTO) DESCARGA     '||unistr('\000a')||
'      ,comobd.ID ID'||unistr('\000a')||
'from   COM_OBJETOS_DOC comobd'||unistr('\000a')||
'      ,COM_OBJETOS     comobj                                                                               '||unistr('\000a')||
...
s:=s||'B_ID = :P268_COMRUB_ID'||unistr('\000a')||
'and    comprv_pkg.comobd_presentado_sn (comobj.segorg_id,'||unistr('\000a')||
'                                        comobj.comprv_id,'||unistr('\000a')||
'                                        comobd.comodt_id,'||unistr('\000a')||
'                                        comobj.ID) not in (''PRESENTADO'', ''NO PRESENTADO'')'||unistr('\000a')||
'--'||unistr('\000a')||
'-- Que HDP ya lo esta usando en la funcion anterior !!!'||unistr('\000a')||
'--'||unistr('\000a')||
'and    comobd.ID = COMPRV_PKG.COMOBD_COMPRV_OBTN_ID';

s:=s||'(p_comodt_id => comobd.comodt_id'||unistr('\000a')||
'                                                   ,p_comprv_id => comobj.COMPRV_ID --:P268_COMPRV_ID'||unistr('\000a')||
'                                                   ,p_comobj_id => comobd.COMOBJ_ID)'||unistr('\000a')||
')'||unistr('\000a')||
'order by COMOBJ_CODIGO, DOCUMENTO                                                   ';

wwv_flow_api.create_report_region (
  p_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 268,
  p_name=> 'Documentos Vencidos / No Presentados',
  p_region_name=>'',
  ...
  p_query_desc_image_attr=> 'width="16" height="16" alt="" ',
  p_plug_query_strip_html=> 'Y',
  p_comment=>'select 1'||unistr('\000a')||
'from   COM_OBJETOS_V comobj'||unistr('\000a')||
'where  comobj.COMPRV_ID = :P268_COMPRV_ID'||unistr('\000a')||
'and    comobj.COMRUB_ID = :P268_COMRUB_ID'||unistr('\000a')||
'and    comobj.COMOBE_ESTADO = ''HAB''');
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366139820199039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366139913997039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140017237039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140109019039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140220942039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140330300039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140410471039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140530095039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140628326039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140722864039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140814680039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366140912527039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366141029513039354 + wwv_flow_api.g_id_offset,
  p_region_id=> 366139605839039354 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
