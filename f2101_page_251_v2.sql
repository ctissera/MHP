...
--   Date and Time:   11:55 Martes Noviembre 1, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161031141329'
  );
null;
...
'  and     com_pkg.obtn_comdoc_no_fmt4 ( p_segorg_id => COMPDO.SEGORG_ID'||unistr('\000a')||
'                                     , p_comprv_id => compdo.comprv_id'||unistr('\000a')||
'                                     , p_compdt_id => compdo.COMPDT_id'||unistr('\000a')||
'                                     , P_COMPDT_TIPO => COMPDO.COMPDT_TIPO'||unistr('\000a')||
'                                     , P_COMPDT_TIPO_DUR';

s:=s||'ACION => COMPDO.COMPDT_TIPO_DURACION'||unistr('\000a')||
...
'          when INSTR(COMPDO.MIMETYPE,''word'') > 0 then ''<img src="#IMAG';

s:=s||'E_PREFIX#ws/download_rtf_32x24.gif">'''||unistr('\000a')||
'          when INSTR(COMPDO.MIMETYPE,''plain'') > 0 then ''<img src="#IMAGE_PREFIX#ws/page_32x24.gif">''    '||unistr('\000a')||
...
'          end) ICONO'||unistr('\000a')||
'      ,COMPDO.SITUACION'||unistr('\000a')||
'      ,dbms_lob.getlength(COM';

s:=s||'PDO.DOCUMENTO) DOCUMENTO'||unistr('\000a')||
'      ,COMPDO.FILENAME'||unistr('\000a')||
'      ,COMPDO.MIMETYPE'||unistr('\000a')||
'      ,COMPDO.LAST_UPDATE_DATE'||unistr('\000a')||
'      ,COMPDO.SITUACION_ABR'||unistr('\000a')||
...
s:=s||'_DURACION_VALOR'||unistr('\000a')||
...
s:=s||'      else ''<a href="#"  onclick="darbaja(''||COMPDO.ID||'');return false;" alt="Dar de Baja Documento" title="Dar de Baja Documento" ><img  src="#WORKSPACE_IMAGES#delete2.png"></a>'''||unistr('\000a')||
'      end) ANULAR_DOC'||unistr('\000a')||
'      ,COM_PKG.OBTN_COMDOC_ESTADO2(p_segorg_id => COMPDO.SEGORG_ID'||unistr('\000a')||
'                                  ,p_comprv_id => COMPDO.COMPRV_ID'||unistr('\000a')||
'                                  ,p_compdt_id => COMPDO.COMPDT';
...
' and com_pkg.obtn_comdoc_no_fmt4 ( p_segorg_id => COMPDO.SEGORG_';
...
'                                  , P_COMPDT_TIPO => COMPDO.COMPDT_TIPO'||unistr('\000a')||
'                                  , P_COMPDT_TIPO_DURACION => COMPDO.COMPDT_TIPO_DURACION'||unistr('\000a')||
'                                  , P_COMPDE_ESTADO => COMPDO.COM';

s:=s||'PDE_ESTADO'||unistr('\000a')||
...
'     , com_pkg.obtn_comdoc_no_fmt3 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                            , p_comprv_id => :P251_ID'||unistr('\000a')||
'                            , p_compdt_id => COMP';

s:=s||'DT.id'||unistr('\000a')||
'                            , p_compdt_tipo => compdt.tipo'||unistr('\000a')||
'                            , P_COMPDT_TIPO_DURACION => COMPDT.TIPO_DURACION'||unistr('\000a')||
'                            , P_COMPDE_ESTADO => COMPDT.COMPDE_ESTADO'||unistr('\000a')||
'                            , P_COMPRT_ID => comptt.comprt_id) SITUACION'||unistr('\000a')||
...
s:=s||'ipo = ''GEN'''||unistr('\000a')||
'  and compdt.compde_estado = ''HAB'''||unistr('\000a')||
'  and comptt.comprt_id = :P251_COMPRT_ID'||unistr('\000a')||
'  and com_pkg.obtn_comdoc_no_fmt3 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                           , p_comprv_id => :P251_ID'||unistr('\000a')||
...
s:=s||'                        , P_COMPDE_ESTADO => COMPDT.COMPDE_ESTADO'||unistr('\000a')||
'                           , P_COMPRT_ID => comptt.comprt_id) in (''NO PRESENTADO'',''VENCIDO'')'||unistr('\000a')||
'union all'||unistr('\000a')||
'select distinct compdt.nombre compdt_nombre'||unistr('\000a')||
'     , replace(replace(COMPRV_PKG.COMPTT_OBTN_RUBROS(p_comprv_id => :P251_ID, p_compdt_id => compdt.id, p_ver_obligatorio_sn => ''SI''),chr(10),''<br>''),''(OBLIGATORIO)'',''<font color="red">(O';

s:=s||'BLIGATORIO)</font>'') compdt_tipo_abr'||unistr('\000a')||
'     , com_pkg.obtn_comdoc_estado2 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                                  , p_comprv_id => comprr.comprv_id'||unistr('\000a')||
'                                  , p_compdt_id => COMPDT.id '||unistr('\000a')||
'                                  , P_COMPDT_TIPO_DURACION => COMPDT.TIPO_DURACION'||unistr('\000a')||
'                                  , P_COMPDE_ESTADO => COMPDT.COMPDE_ESTADO  ) ES';

s:=s||'TADO'||unistr('\000a')||
'     ,com_pkg.obtn_comdoc_no_fmt5 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                          , p_comprv_id => comprr.comprv_id'||unistr('\000a')||
'                          , p_compdt_id => COMPDT.id'||unistr('\000a')||
'                          , p_compdt_tipo => compdt.tipo'||unistr('\000a')||
'                          , P_COMPDT_TIPO_DURACION => COMPDT.TIPO_DURACION'||unistr('\000a')||
...
s:=s||'m com_proveedores_dot_v compdt'||unistr('\000a')||
...
s:=s||'rv_id => comprr.comprv_id'||unistr('\000a')||
'                          , p_compdt_id => COMPDT.id'||unistr('\000a')||
'                          , p_compdt_tipo => compdt.tipo'||unistr('\000a')||
'                          , P_COMPDT_TIPO_DURACION => COMPDT.TIPO_DURACION'||unistr('\000a')||
