...
--   Date and Time:   10:09 Martes Marzo 28, 2017
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170328100829'
  );
null;
...
wwv_flow_api.create_page_process(
  ...
  p_process_error_message=> 'Error en Confirmar Edición SQLERRM',
...
'      v_compet_cantidad NUMBER;'||unistr('\000a')||
'      v_compet_precio NUMBER;'||unistr('\000a')||
'      v_compet_observacion varchar2(100);'||unistr('\000a')||
'    BEGIN'||unistr('\000a')||
'     -- g_f02 (Cantidad)'||unistr('\000a')||
'     -- Verificar Cantidad en Blanc';
...
p:=p||'application.g_f02(i),''%''||''null%'',NULL),'','',''.''),''999999999999990.00'');'||unistr('\000a')||
'       EXCEPTION'||unistr('\000a')||
'         WHEN OTHERS THEN'||unistr('\000a')||
'           v_mensaje := v_mensaje || ''Debe indicar un valor numérico en la cantidad del detalle: ''|| i||''<br>'';'||unistr('\000a')||
'           v_compet_correcto := ''NO'';'||unistr('\000a')||
...
p:=p||'ET CANTIDAD = v_compet_cantidad'||unistr('\000a')||
'          ,PRECIO_UNITARIO = v_compet_precio'||unistr('\000a')||
'          ,OBSERVACION = v_compet_observacion'||unistr('\000a')||
'       WHERE id = apex_application.g_f01(i);'||unistr('\000a')||
'       --'||unistr('\000a')||
...
'     END IF; '||unistr('\000a')||
'     apex_application.g_print_success_message := v_mensaje||'||unistr('\000a')||
'     ''<br>Los detalles con error han sido restau';

p:=p||'rados con su información original.'';'||unistr('\000a')||
'  END IF;'||unistr('\000a')||
' --'||unistr('\000a')||
'END;';
...
wwv_flow_api.create_page_process(
  ...
  p_process_sql_clob => p,
  p_process_error_message=> 'Error en Confirmar Edición_2 #SQLERRM#',
  p_error_display_location=> 'ON_ERROR_PAGE',
