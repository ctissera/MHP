...
--   Date and Time:   12:29 Lunes Diciembre 19, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161215124234'
  );
null;
...
s:=s||'.comoce_estado = ''APR'') value, ''f?p=COMCON:410:&SESSION.::NO:RIR,410:G_APP_ANTERIOR,G_APP_ANTERIOR_PAG,P410_COMPRV_ID,P410_FILTRO_PREDEFINIDO_SEL:&APP_ID.,&APP_PAGE_ID.,&P1_COMPRV_ID.,OPDE'' url,100 pct'||unistr('\000a')||
