...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170612085253'
  );
null;
...
':P216_TIPO_PERSONA := v_comprt.TIPO_PERSONA;'||unistr('\000a')||
...
s:=s||'print(''CUIT : <b>''||v_comprv.CUIT||''</b><br>'');'||unistr('\000a')||
'END;';
...
wwv_flow_api.create_page_plug (
  p_id=> 367500205484895229 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 3004,
  p_plug_name=> 'Mensaje',
  p_region_name=>'',
