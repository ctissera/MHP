...
--   Date and Time:   12:25 Jueves Mayo 4, 2017
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170421091510'
  );
null;
...
p:=p||'comres.OBSERVACION      := null;'||unistr('\000a')||
'      --'||unistr('\000a')||
'      COM_PKG.INS_COMRES(p_comres=> v_comres);'||unistr('\000a')||
'      --      '||unistr('\000a')||
'      '||unistr('\000a')||
...
p:=p||'_ID := v_comtps.ID;'||unistr('\000a')||
'      --'||unistr('\000a')||
'    END;'||unistr('\000a')||
'    --'||unistr('\000a')||
'  END IF;'||unistr('\000a')||
