...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170608124451'
  );
null;
...
'  htp.print(v_comprt.CODIGO||'' : <b>''||v_';

s:=s||'comtpr.NOMBRE||''</b><br>'');'||unistr('\000a')||
...
s:=s||' de tipo de persona en oculto  '||unistr('\000a')||
'  :P211_TIPO_PERSONA := v_comprt.TIPO_PERSONA;'||unistr('\000a')||
'  --'||unistr('\000a')||
'  :P212_TIPO := v_comtpr.TIPO;'||unistr('\000a')||
'  :P212_TIPO_PERSONA:=v_comprt.TIPO_PERSONA; '||unistr('\000a')||
'  --'||unistr('\000a')||
'  declare'||unistr('\000a')||
...
wwv_flow_api.create_page_plug (
  p_id=> 367692709454266256 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 211,
  p_plug_name=> 'Mensaje',
  p_region_name=>'',
...
'   --'||unistr('\000a')||
'   return (:P211_TIPO_TRAMITE=''ACRS'')and(:P211_TIPO_PERSONA=''JUR'');'||unistr('\000a')||
'end;',
  p_pagination_display_position=>'BOTTOM_RIGHT',
  p_plug_customized=>'0',
  p_plug_caching=> 'NOT_CACHED',
...
begin
wwv_flow_api.create_page_item(
  p_id=>367694508133451357 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 211,
  p_name=>'P211_TIPO_PRV',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 360,
