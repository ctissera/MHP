...
--   Date and Time:   14:10 Miércoles Octubre 19, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161019140825'
  );
null;
...
'     ,COM_PKG.OBTN_COMDOC_ESTADO(p_segorg_id => COMPDO.SEGORG_ID, p_comprv_id => ';

s:=s||'compdo.COMPRV_ID, p_compdt_id => compdo.COMPDT_ID) ESTADO'||unistr('\000a')||
'          ,replace(replace(COMPRV_PKG.COMPTT_OBTN_RUBROS(p_comprv_id => compdo.comprv_id, p_compdt_id => compdo.compdt_id, p_ver_obligatorio_sn => ''SI''),chr(10),''<br>''),''(OBLIGATORIO)'',''<font color="red">(OBLIGATORIO)</font>'')  RUBRO_DOC'||unistr('\000a')||
' from  COM_PROVEEDORES_DOC_V COMPDO'||unistr('\000a')||
' where  COMPRV_ID = :P251_ID'||unistr('\000a')||
' and COMPDO.COMPDT_TIPO_DURACION = ''SIN';
...
s:=s||'     , p_compdt_id => compdo.COMPDT_id) not in (''NO RELACIONADO'')'||unistr('\000a')||
...
'      ,(case '||unistr('\000a')||
'          when INSTR(COMPDO.MIMETYPE,''pdf'') > 0 then ''<img src="#IMAGE_PREFIX#ws/download_pdf_32x24.gif">'''||unistr('\000a')||
'          when INSTR(COMPDO.MIMETYPE,''excel''';

s:=s||') > 0 then ''<img src="#IMAGE_PREFIX#ws/download_csv_32x24.gif">'''||unistr('\000a')||
'          when INSTR(COMPDO.MIMETYPE,''oct'') > 0 then ''<img src="#IMAGE_PREFIX#ws/page_32x24.gif">'''||unistr('\000a')||
'          when INSTR(COMPDO.MIMETYPE,''word'') > 0 then ''<img src="#IMAGE_PREFIX#ws/download_rtf_32x24.gif">'''||unistr('\000a')||
'          when INSTR(COMPDO.MIMETYPE,''plain'') > 0 then ''<img src="#IMAGE_PREFIX#ws/page_32x24.gif">''    '||unistr('\000a')||
'          when INSTR(CO';

s:=s||'MPDO.MIMETYPE,''image'') > 0 then ''<img src="#IMAGE_PREFIX#ws/chart_32x24.gif">''    '||unistr('\000a')||
'          else'||unistr('\000a')||
'            ''<img src="#IMAGE_PREFIX#ws/page_32x24.gif">''    '||unistr('\000a')||
'          end) ICONO'||unistr('\000a')||
'      ,COMPDO.SITUACION'||unistr('\000a')||
...
s:=s||' ,COMPDO.DATE_CREATED'||unistr('\000a')||
'      ,COMPDO.CREATED_BY'||unistr('\000a')||
'      ,COMPDO.DATE_MODIFIED'||unistr('\000a')||
...
'          when ''ANU'' then ''ANULADA'''||unistr('\000a')||
'          else ''<a href="#"  onclick="darbaja(''||COMPDO.ID||'');return false;" alt="Dar de Baja Documento" title="Dar de Baja Documento" ><img  src="#WORKSPACE_IMAGES#dele';

s:=s||'te2.png"></a>'''||unistr('\000a')||
'      end) ANULAR_DOC'||unistr('\000a')||
'     ,COM_PKG.OBTN_COMDOC_ESTADO(p_segorg_id => COMPDO.SEGORG_ID, p_comprv_id => compdo.COMPRV_ID, p_compdt_id => compdo.COMPDT_ID) ESTADO'||unistr('\000a')||
...
'  and  com_pkg.obtn_comdoc_no_fmt ( p_segorg_id => COMPDO.SEGORG';

s:=s||'_ID'||unistr('\000a')||
'                                  , p_comprv_id => compdo.comprv_id'||unistr('\000a')||
'                                  , p_compdt_id => compdo.COMPDT_id) not in (''NO RELACIONADO'')';
...
'        where  comrub.ID = comobd.COMRUB_ID)||decode(OBLIGATORIO_SN,''SI'','' - <span style="co';

s:=s||'lor:red">(OBLIGATORIO)</span>'','' - (OPCIONAL)'') RUBRO'||unistr('\000a')||
...
s:=s||'                               ,p_comobj_id => comobd.COMOBJ_ID) = ''PRESENTADO''                                      '||unistr('\000a')||
...
s:=s||'                              , p_compdt_id => COMPDT.id  ) ESTADO'||unistr('\000a')||
'     , com_pkg.obtn_comdoc_no_fmt ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                                 , p_comprv_id => :P251_ID'||unistr('\000a')||
'                                 , p_compdt_id => COMPDT.id) SITUACION'||unistr('\000a')||
...
s:=s||'mpdt.compde_estado = ''HAB'''||unistr('\000a')||
...
'     , replace(replace(COMPRV_PKG.COMPTT_OBTN_RUBROS(p_compr';

s:=s||'v_id => :P251_ID, p_compdt_id => compdt.id, p_ver_obligatorio_sn => ''SI''),chr(10),''<br>''),''(OBLIGATORIO)'',''<font color="red">(OBLIGATORIO)</font>'') compdt_tipo_abr'||unistr('\000a')||
'     , com_pkg.obtn_comdoc_estado ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                                  , p_comprv_id => :P251_ID'||unistr('\000a')||
'                                  , p_compdt_id => COMPDT.id  ) ESTADO'||unistr('\000a')||
'     ,com_pkg.obtn_comdoc_no_fmt ( p_';

s:=s||'segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                                 , p_comprv_id => :P251_ID'||unistr('\000a')||
'                                 , p_compdt_id => COMPDT.id) SITUACION'||unistr('\000a')||
'from com_proveedores_dot_v compdt'||unistr('\000a')||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 12574932289742042 + wwv_flow_api.g_id_offset,
  p_region_id=> 14725616277486725 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
'       ,ESTADO_DESC ESTADO'||unistr('\000a')||
...
s:=s||'a.compcc_codigo'||unistr('\000a')||
...
s:=s||'               from com_proveedores_aut_v compra1'||unistr('\000a')||
...
'  and (NVL(:P251_FILTRO_ESTADO3,''V';

s:=s||'IG'') = ''VIG'' or :P251_FILTRO_ESTADO3 = ''VIGHIS'')'||unistr('\000a')||
'union'||unistr('\000a')||
...
'        ,compra.tipo_documento'||unistr('\000a')||
'        ,compra.numero_documento'||unistr('\000a')||
'        ,compra.tipo_documento||'': ''||compra.nu';

s:=s||'mero_documento documento'||unistr('\000a')||
'        ,compra.apellido||'' ''||compra.nombre compra_apellido_nombre'||unistr('\000a')||
'        ,to_char(compra.fecha_inicio,''DD/MM/YYYY'')||'' - ''||to_char(compra.fecha_vencimiento,''DD/MM/YYYY'') compra_duracion'||unistr('\000a')||
'        ,compra.situacion'||unistr('\000a')||
'        ,(case '||unistr('\000a')||
'            when ((compra.fecha_vencimiento < sysdate) and (compra.situacion = ''VIG'' or compra.situacion = ''MAR'')) then ''<span style="color: re';

s:=s||'d;"><strong>VENCIDO</strong></span>'''||unistr('\000a')||
...
s:=s||'       end)situacion_abr'||unistr('\000a')||
'        ,compra.fecha_situacion'||unistr('\000a')||
'        ,compra.motivo_situacion'||unistr('\000a')||
'        ,compra.comprv_cuit'||unistr('\000a')||
'        ,compra.comprv_nombre'||unistr('\000a')||
...
'        ,compra.compct_codigo'||unistr('\000a')||
'        ,compra.compct_nombre  '||unistr('\000a')||
'        ,decode(comprv_pkg.compra_debe_sn(p_compra_id => compra.id),''SI'',''<span style="color:red"><b>DEBE</b></span>'',''<span style';

s:=s||'="color:green"><b>AL DIA</b></span>'') debe'||unistr('\000a')||
'from  com_proveedores_aut_v compra'||unistr('\000a')||
'where compra.comprv_id = :P251_ID'||unistr('\000a')||
