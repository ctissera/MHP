...
--   Date and Time:   13:34 Miércoles Junio 28, 2017
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170607151232'
  );
null;
...
s:=s||'and trunc(sysdate) > trunc( comocm_pkg.OBTN_COMOCM_FECHA_GENERACION(comocm.comcon_id, comocm.comprv_id) )'||unistr('\000a')||
