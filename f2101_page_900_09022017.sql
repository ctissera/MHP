...
--   Date and Time:   08:46 Jueves Febrero 9, 2017
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170206145424'
  );
null;
...
s:=s||'/b><br>Cantidad Solicitada: <b>''||to_char(comczd.COMPET_CANTIDAD)||'||unistr('\000a')||
...
'      , NVL((SELECT NOMBRE FROM COM_PROVEEDORES_V COMPRV_V WHERE CO';

s:=s||'MPRV_V.ID = COMCZD.COMPRV_ID AND comczd.EVALUACION > 0),''NO SE PRESENTARON COTIZACIONES'') comprv_nombre'||unistr('\000a')||
...
'              DECODE(COM_PKG.OBTN_COMPARATIVA_CTP(P_PRECIO_TESTIGO => comczd.COMPET_PRECIO_UNITARIO,P_PRECIO_COTIZADO => comczd.PRECIO_UNITARIO';

s:=s||'_FINAL)'||unistr('\000a')||
'              ,1,''<b><font color="RED">''||DECODE(TO_CHAR(comczd.PRECIO_UNITARIO_FINAL),'''','''',''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99'')))||''</b></font>'''||unistr('\000a')||
...
s:=s||'or="GREEN">''||DECODE(TO_CHAR(comczd.PRECIO_UNITARIO_FINAL),'''','''',''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99'')))||''</b></font>'' '||unistr('\000a')||
'                    ),''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99''))'||unistr('\000a')||
'             ) PRECIO_UNITARIO_COTIZADO'||unistr('\000a')||
'      , DECODE(TO_CHAR(comczd.COMPET_CANTIDAD * comczd.PRECIO_UNITARIO_FINAL),'''','''',''$''||LTRIM (TO_CHAR(comczd.COMPET_CA';

s:=s||'NTIDAD * comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99''))) PRECIO_TOTAL_COTIZADO'||unistr('\000a')||
'      '||unistr('\000a')||
'      '||unistr('\000a')||
...
''||unistr('\000a')||
'      , nvl(date_modified_czd, comczd.DATE_CREATED) FECHA_COTIZACION'||unistr('\000a')||
''||unistr('\000a')||
'   FROM COM_COTIZACIONES_D';

s:=s||'ET_V comczd'||unistr('\000a')||
' WHERE comczd.COMCON_ID = :P900_COMCON_ID'||unistr('\000a')||
'     AND comczd.COMCTZ_SITUACION = ''PRE'''||unistr('\000a')||
'     AND COMCZD.PRECIO_UNITARIO_FINAL IS NOT NULL     '||unistr('\000a')||
...
'''</font> - ''||comczd.compet_codigo||'' ''||'||unistr('\000a')||
'comczd.compet_descripcion||'||unistr('\000a')||
'DECODE(comczd.COMPET_OBS';

s:=s||'ERVACION, '''', '''', '' - ''||comczd.COMPET_OBSERVACION)||'||unistr('\000a')||
'''</b><br>Cantidad Solicitada: <b>''||to_char(comczd.COMPET_CANTIDAD)||'||unistr('\000a')||
'''</b> - Precio Unitario Referencia: <b>''||TO_CHAR(comczd.compet_precio_unitario,''$999,999,990.99'')||'||unistr('\000a')||
'''</b> - Precio Total Sugerido: <b>''||TO_CHAR(comczd.compet_cantidad*comczd.compet_precio_unitario,''$999,999,990.99'') ||''</b>''  DESCRIPCION'||unistr('\000a')||
'      , 0 EVALUACION'||unistr('\000a')||
'      , ''NO COT';

s:=s||'IZADO'' comprv_nombre'||unistr('\000a')||
'      , 0 comprv_id'||unistr('\000a')||
'      , ''NO COTIZADO'' MARCA'||unistr('\000a')||
'      , ''NO COTIZADO'' MODELO '||unistr('\000a')||
...
'      , comczd.COMPET_RENGLON'||unistr('\000a')||
'      , '' '' COMCTZ_OBSERVACION'||unistr('\000a')||
'      , null FECHA_COTIZACION'||unistr('\000a')||
'   FROM COM_COTIZACIONES_DET2_V comczd'||unistr('\000a')||
' WHERE comczd.COMCON_ID = :P900_COMCON_ID'||unistr('\000a')||
'--';

s:=s||'   AND comczd.COMPED_ID = :P900_COMPED_ID'||unistr('\000a')||
''||unistr('\000a')||
')'||unistr('\000a')||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366122804243383376 + wwv_flow_api.g_id_offset,
  p_region_id=> 5459032400507640 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 14,
  p_form_element_id=> null,
  p_column_alias=> 'FECHA_COTIZACION',
  p_column_display_sequence=> 14,
  p_column_heading=> 'Fecha Cotización',
  p_use_as_row_header=> 'N',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  ...
  p_hidden_column=> 'N',
  p_display_when_cond_type=> 'PLSQL_EXPRESSION',
  p_display_when_condition=> ':P1_SEGAPL_CODIGO in (''ADMCOM'',''ECOCOM_POR'') and :P811_ESTADO IN (''VRF'',''ENV'',''INF'',''ACR'',''RES'',''ADJ'',''NAD'',''FIN'',''PRE'',''CAN'')',
  p_display_as=>'ESCAPE_SC',
  p_lov_show_nulls=> 'NO',
  p_is_required=> false,
  p_pk_col_source=> s,
...
'      , COMCTZ_OBSERVACION'||unistr('\000a')||
'from ('||unistr('\000a')||
'         SELECT ''<b><font color="red">ITEM: ''||comczd.compet_renglon|| ''</font> - ''||comczd.compet_codigo||'' ''||'||unistr('\000a')||
'               comczd.compet_descripcion||  substr(DECODE(comczd.COMPET_OBSERVACION, '''', '''', '' - ''||comczd.COMPET_OBSERVACION),1,1000)||'||unistr('\000a')||
' ';

s:=s||'              ''</b><br>Cantidad Solicitad: <b>''||to_char(comczd.COMPET_CANTIDAD)|| ''</b> - Precio Unitario Referencia: <b>''||TO_CHAR(comczd.compet_precio_unitario,''$999,999,990.99'')||'||unistr('\000a')||
'               ''</b> - Precio Total Sugerido: <b>''||TO_CHAR(comczd.compet_cantidad*comczd.compet_precio_unitario,''$999,999,990.99'') ||''</b>'' DESCRIPCION'||unistr('\000a')||
'               , comczd.EVALUACION'||unistr('\000a')||
'               , NVL((SELECT';

s:=s||' NOMBRE FROM COM_PROVEEDORES_V COMPRV_V WHERE COMPRV_V.ID = COMCZD.COMPRV_ID AND comczd.EVALUACION > 0),''NO SE PRESENTARON COTIZACIONES'') comprv_nombre'||unistr('\000a')||
'               , COMCZD.COMPRV_ID COMPRV_ID'||unistr('\000a')||
'               , comczd.MARCA'||unistr('\000a')||
'               , comczd.MODELO '||unistr('\000a')||
'               , comczd.OBSERVACION '||unistr('\000a')||
'               ,DECODE(:P811_PRECIO_TESTIGO_SN , ''SI'','||unistr('\000a')||
'                       DECODE(COM_PKG.OBTN_COMPARA';

s:=s||'TIVA_CTP(P_PRECIO_TESTIGO => comczd.COMPET_PRECIO_UNITARIO,P_PRECIO_COTIZADO => comczd.PRECIO_UNITARIO_FINAL)'||unistr('\000a')||
'                       ,1,''<b><font color="RED">''||DECODE(TO_CHAR(comczd.PRECIO_UNITARIO_FINAL),'''','''',''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99'')))||''</b></font>'''||unistr('\000a')||
'                       ,0,''<b><font color="Darkorange">''||DECODE(TO_CHAR(comczd.PRECIO_UNITARIO_FINAL),''';

s:=s||''','''',''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99'')))||''</b></font>'''||unistr('\000a')||
'                       ,-1,''<b><font color="GREEN">''||DECODE(TO_CHAR(comczd.PRECIO_UNITARIO_FINAL),'''','''',''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99'')))||''</b></font>'' '||unistr('\000a')||
'                             ),''$''||LTRIM (TO_CHAR(comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99''))'||unistr('\000a')||
'                      ';

s:=s||') PRECIO_UNITARIO_COTIZADO'||unistr('\000a')||
'               , DECODE(TO_CHAR(comczd.COMPET_CANTIDAD * comczd.PRECIO_UNITARIO_FINAL),'''','''',''$''||LTRIM (TO_CHAR(comczd.COMPET_CANTIDAD * comczd.PRECIO_UNITARIO_FINAL,''999,999,990.99''))) PRECIO_TOTAL_COTIZADO'||unistr('\000a')||
'               '||unistr('\000a')||
'               '||unistr('\000a')||
'               ,decode(comczd.COMPET_COMCIT_ID,'''','''', replace(comczd.INFORME_EVALUACION,''IMAGE_PREFIX.'',''#IMAGE_PREFIX#'')) PRECIO_TO';
...
s:=s||'CION IS NOT NULL'||unistr('\000a')||
'         '||unistr('\000a')||
'         UNION ALL'||unistr('\000a')||
'         '||unistr('\000a')||
'         SELECT ''<b><font color="red">ITEM: ''||comczd.compet_renglon||'||unistr('\000a')||
...
'               ''</b><br>Cantidad Solicitada: <b>''||to_char(comczd.COMPET_CANTIDA';
...
s:=s||'COTIZADO'' MARCA'||unistr('\000a')||
'               , ''NO COTIZADO'' MODELO '||unistr('\000a')||
'               , ''NO COTIZADO'' OBSERVACION '||unistr('\000a')||
'               , '''' PRECIO_UNITARIO_COTIZADO'||unistr('\000a')||
'               , '''' PRECIO_TOTAL_COTIZADO'||unistr('\000a')||
...
wwv_flow_api.create_report_region (
  p_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 900,
  p_name=> 'Detalle de &P1_COMETQ_PRO. 2',
  p_region_name=>'',
  p_template=> 142027656270227099+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365148607495307453 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'DESCRIPCION',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365148717168307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365148812825307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365148930824307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149013202307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149105338307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149207805307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149313947307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149407392307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149504169307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149621224307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149724539307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 365149829317307460 + wwv_flow_api.g_id_offset,
  p_region_id=> 365148416842307360 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
