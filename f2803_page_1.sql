...
--   Date and Time:   14:02 Lunes Octubre 24, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161024121754'
  );
null;
...
s:=s||'o_fmt ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
...
'  and comtdr.comrub_id = comprr.com';

s:=s||'rub_id'||unistr('\000a')||
...
s:=s||'distinct comode.ID comodt_id'||unistr('\000a')||
...
'and    comode.ESTADO <> ''PRESENTADO''))  value, ''f?p=COMCON:510:&SESSION.::NO:RIR,510:G_APP_ANTERIOR,G_APP_ANTERIOR_PAG,P510_COMPRV_ID:&APP_ID.,&APP_PAGE_ID.,&';

s:=s||'P1_COMPRV_ID.'' url, 100 pct'||unistr('\000a')||
'from dual'||unistr('\000a')||
'';
