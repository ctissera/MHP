...
--   Date and Time:   10:01 Lunes Junio 26, 2017
...
'}'||unistr('\000a')||
''||unistr('\000a')||
'function enfocarAutoridades() {'||unistr('\000a')||
''||unistr('\000a')||
'  if ($("#P251_ENFOCAR_AUT").v'||
'al() == ''SI'') {'||unistr('\000a')||
'    $(''html, body'').animate({'||unistr('\000a')||
'        scrollTop: $("#AUTORIDADES").offset().top'||unistr('\000a')||
'    });'||unistr('\000a')||
'    $("#P251_ENFOCAR_AUT").val('''');'||unistr('\000a')||
'    }'||unistr('\000a')||
'}'
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170405172926'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select distinct compdt.id compdt_id'||unistr('\000a')||
...
s:=s||'      , p_comprv_id => :P251_ID'||unistr('\000a')||
...
'      , upper(compdt.nombre) compdt_nombre'||unistr('\000a')||
'      , replace(replace(COMPRV_PKG.COMPTT_OBTN_RUBROS(p_com';

s:=s||'prv_id => :P251_ID, p_compdt_id => compdt.id, p_ver_obligatorio_sn => ''SI''),chr(10),''<br>''),''(OBLIGATORIO)'',''<font color="red">(OBLIGATORIO)</font>'') compdt_tipo_abr'||unistr('\000a')||
'     , com_pkg.obtn_comdoc_estado2 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
...
s:=s||'compdt.compde_estado = ''HAB'''||unistr('\000a')||
'  and comprr.comprv_id = :P251_ID'||unistr('\000a')||
'  and com_pkg.obtn_comdoc_no_fmt2 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                                  , p_comprv_id => comprr.comprv_id'||unistr('\000a')||
'                                  , p_compdt_id => COMPDT.id'||unistr('\000a')||
'                                  , p_compdt_tipo => compdt.tipo'||unistr('\000a')||
'                                  , P_COMPDT_TIPO_DURACION => COMPDT.TIPO_D';

s:=s||'URACION'||unistr('\000a')||
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366224332014102298 + wwv_flow_api.g_id_offset,
  p_region_id=> 14725616277486725 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'COMPDT_ID',
  p_column_display_sequence=> 4,
  p_column_heading=> 'Compdt Id',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'CENTER',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
...
'       ,comprr.comrub_NOMBRE RUBRO'||unistr('\000a')||
'       ,comode.ESTADO'||unistr('\000a')||
'from   COM_OBJETOS_DOC_ESTADO_V2 comode'||unistr('\000a')||
'      ,com_proveedores_rub2_v comprr'||unistr('\000a')||
'where  comode.COMOBJ_COMPRV_I';

s:=s||'D = comprr.comprv_id --:P510_COMPRV_ID'||unistr('\000a')||
'and    comprr.comrub_id = comode.COMOBJ_COMRUB_ID  '||unistr('\000a')||
'and    comode.COMOBJ_COMPRV_ID = :P251_ID'||unistr('\000a')||
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select comobd.comodt_id'||unistr('\000a')||
'from (select comobdi.comobj_id'||unistr('\000a')||
'           , comobdi.comodt_id'||unistr('\000a')||
'           , nvl(comobdi.fecha_vencimiento,sysdate + 1) fecha_vencimiento'||unistr('\000a')||
'           , dense_rank() over (partition by comobdi.comobj_id'||unistr('\000a')||
'                                            ,comobdi.comodt_id '||unistr('\000a')||
'                                order by comobdi.comobj_id'||unistr('\000a')||
'                                        ,comobdi.comod';

s:=s||'t_id'||unistr('\000a')||
'                                        ,comobdi.fecha_vencimiento desc) rank'||unistr('\000a')||
'      from com_objetos_doc  comobdi'||unistr('\000a')||
'         , com_objetos      comobji'||unistr('\000a')||
'     where comobdi.comobj_id      = comobji.id'||unistr('\000a')||
'       --and comobdi.obligatorio_sn = ''SI'''||unistr('\000a')||
'       and comobdi.situacion      = ''VAL'''||unistr('\000a')||
'       and comobdi.fecha_vencimiento is not null'||unistr('\000a')||
'       and comobji.comprv_id      = :P251_ID'||unistr('\000a')||
'     GROUP BY COMOB';

s:=s||'DI.COMOBJ_ID, comobdi.comodt_id, fecha_vencimiento'||unistr('\000a')||
'       ) comobd'||unistr('\000a')||
'       '||unistr('\000a')||
'     , com_objetos          comobj'||unistr('\000a')||
'where comobj.id          = comobd.comobj_id'||unistr('\000a')||
'and comobj.comprv_id   = :P251_ID'||unistr('\000a')||
'and rank = 1'||unistr('\000a')||
'--and rownum = 1'||unistr('\000a')||
'and comobd.fecha_vencimiento < sysdate'||unistr('\000a')||
''||unistr('\000a')||
''||unistr('\000a')||
'/*select distinct comodt_ID'||unistr('\000a')||
'       ,comode.COMOBJ_ID'||unistr('\000a')||
'       ,comode.COMOBJ_COMPRV_ID '||unistr('\000a')||
'       ,comode.SEGORG_ID '||unistr('\000a')||
'       ,comode.NOMBRE DOCUMEN';
...
s:=s||'  comode.SEGORG_ID = :P1_SEGORG_ID'||unistr('\000a')||
'and    comode.ESTADO <> ''PRESENTADO'''||unistr('\000a')||
'and    comprr.situacion = ''ACT'''||unistr('\000a')||
'and    comprr.comrub_situacion = ''VIG'''||unistr('\000a')||
'order by comode.COMOBJ_CODIGO, comode.NOMBRE*/';
...
wwv_flow_api.create_report_region (
  p_id=> 366286900620168475 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 251,
  p_name=> 'Documentos por Objeto de &P1_COMETQ_RUB. +',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366288218909209076 + wwv_flow_api.g_id_offset,
  p_region_id=> 366286900620168475 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'COMODT_ID',
  p_column_display_sequence=> 1,
  p_column_heading=> 'Comodt Id',
  p_column_alignment=>'LEFT',
  p_heading_alignment=>'CENTER',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'Y',
...
'                       and compra1.comprv_id = compra.com';

s:=s||'prv_id --:P251_ID'||unistr('\000a')||
'                  group by compra1.compcc_id, compra1.numero_documento,compra1.comprv_id,compra1.tipo_documento)'||unistr('\000a')||
''||unistr('\000a')||
'  and compra.compct_id = compra.compct_id --:P251_COMPCT_ID'||unistr('\000a')||
...
'        ,to_char(compra.fecha';

s:=s||'_inicio,''DD/MM/YYYY'')||'' - ''||to_char(compra.fecha_vencimiento,''DD/MM/YYYY'') compra_duracion'||unistr('\000a')||
'        ,compra.situacion'||unistr('\000a')||
'        ,(case '||unistr('\000a')||
'            when ((compra.fecha_vencimiento < sysdate) and (compra.situacion = ''VIG'' or compra.situacion = ''MAR'')) then ''<span style="color: red;"><strong>VENCIDO</strong></span>'''||unistr('\000a')||
'            when compra.situacion = ''VIG'' then ''<span style="color:green"><b>''||situa';

s:=s||'cion_abr||''</b></span>'''||unistr('\000a')||
'            when compra.situacion = ''MAR'' then ''<span style="color:red"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
...
s:=s||'    ,compra.comprv_nombre'||unistr('\000a')||
'        ,compra.compcc_codigo'||unistr('\000a')||
'        ,compra.compcc_nombre'||unistr('\000a')||
'        ,compra.compct_codigo'||unistr('\000a')||
'        ,compra.compct_nombre  '||unistr('\000a')||
...
s:=s||'ra.situacion not in (''NUE'',''ANU'')'||unistr('\000a')||
'  and compra.compct_id = compra.compct_id --:P251_COMPCT_ID'||unistr('\000a')||
...
'      ,compra.numero_documento'||unistr('\000a')||
'      ,compra.tipo_documento||'': ''||compra.numero_documento documento'||unistr('\000a')||
'      ,compra.apellido||'' ''||compra.nombre compra_apel';

s:=s||'lido_nombre'||unistr('\000a')||
'      ,to_char(compra.fecha_inicio,''DD/MM/YYYY'')||'' - ''||to_char(compra.fecha_vencimiento,''DD/MM/YYYY'') compra_duracion'||unistr('\000a')||
'      ,compra.situacion'||unistr('\000a')||
'      ,(case '||unistr('\000a')||
'          when ((compra.fecha_vencimiento < sysdate) and (compra.situacion = ''VIG'' or compra.situacion = ''MAR'')) then ''<span style="color: red;"><strong>VENCIDO</strong></span>'''||unistr('\000a')||
'          when compra.situacion = ''VIG'' then ''<span ';

s:=s||'style="color:green"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
'          when compra.situacion = ''MAR'' then ''<span style="color:red"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
'          when compra.situacion = ''APE'' then ''<span style="color:rgb(255, 131, 0)"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
'          when compra.situacion = ''SUS'' then ''<span style="color:red"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
'          else co';

s:=s||'mpra.situacion_abr'||unistr('\000a')||
'       end)situacion_abr'||unistr('\000a')||
'      ,compra.fecha_situacion'||unistr('\000a')||
'      ,compra.motivo_situacion'||unistr('\000a')||
'      ,compra.comprv_cuit'||unistr('\000a')||
...
'      ,compra.compct_codigo'||unistr('\000a')||
'      ,COMPRA.COMPCT_NOMBRE  '||unistr('\000a')||
'      ,DECODE(COMPRV_PKG.COMPRA_DEBE_SN(P_COMPRA_ID => COMPRA.ID),''SI'',''<span style="color:red"><b>DEBE</b></span>'',''<span styl';

s:=s||'e="color:green"><b>AL DIA</b></span>'') DEBE'||unistr('\000a')||
'FROM ('||unistr('\000a')||
'        SELECT  compra1.*'||unistr('\000a')||
'                ,DENSE_RANK() OVER (PARTITION BY COMPRA1.COMPCC_ID, COMPRA1.NUMERO_DOCUMENTO, COMPRA1.COMPRV_ID, COMPRA1.TIPO_DOCUMENTO'||unistr('\000a')||
'                                    ORDER BY COMPRA1.ID DESC) RANK'||unistr('\000a')||
'        FROM COM_PROVEEDORES_AUT_V COMPRA1'||unistr('\000a')||
'        WHERE COMPRA1.SITUACION NOT IN (''NUE'',''ANU'')'||unistr('\000a')||
'        AND COMPRA1.COMP';

s:=s||'RV_ID = :P251_ID) COMPRA'||unistr('\000a')||
'where compct_id = compra.compct_id --:P251_COMPCT_ID'||unistr('\000a')||
'  AND SITUACION IN (''VIG'',''MAR'',''APE'',''SUS'')'||unistr('\000a')||
'  AND (NVL(:P251_FILTRO_ESTADO3,''VIG'') = ''VIG'' OR :P251_FILTRO_ESTADO3 = ''VIGHIS'')'||unistr('\000a')||
'  and rank = 1'||unistr('\000a')||
''||unistr('\000a')||
'union'||unistr('\000a')||
...
s:=s||'pra.situacion'||unistr('\000a')||
'        ,(case '||unistr('\000a')||
'            when ((compra.fecha_vencimiento < sysdate) and (compra.situacion = ''VIG'' or compra.situacion = ''MAR'')) then ''<span style="color: red;"><strong>VENCIDO</strong></span>'''||unistr('\000a')||
'            when compra.situacion = ''VIG'' then ''<span style="color:green"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
'            when compra.situacion = ''MAR'' then ''<span style="color:red"><b>''||sit';

s:=s||'uacion_abr||''</b></span>'''||unistr('\000a')||
'            when compra.situacion = ''BAJ'' then ''<span style="color:red"><b>''||situacion_abr||''</b></span>'''||unistr('\000a')||
'            else compra.situacion_abr'||unistr('\000a')||
'         end)situacion_abr'||unistr('\000a')||
'        ,compra.fecha_situacion'||unistr('\000a')||
...
s:=s||'a.situacion = ''BAJ'''||unistr('\000a')||
'  and (NVL(:P251_FILTRO_ESTADO3,''VIG'') = ''HIS'' or :P251_FILTRO_ESTADO3 = ''VIGHIS'') ';

wwv_flow_api.create_report_region (
  p_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 251,
  p_name=> 'Autoridades TEST',
  p_region_name=>'TEST',
  p_template=> 142031563346227101+ wwv_flow_api.g_id_offset,
...
'  return nvl(v_comprt_codigo, '''') = ''JUR'';'||unistr('\000a')||
'end;'||unistr('\000a')||
'-- Condicion Visibilidad'||unistr('\000a')||
':P251_COMPCT_ID is not null');
end;
/
declare
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366333922851163603 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'ID',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334004593163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334119073163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334207658163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334302505163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334403896163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334519277163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334632182163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334719647163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 9,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334827815163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 10,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366334910294163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 11,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335023291163607 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 12,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335123801163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 13,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335202336163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 14,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335322049163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 15,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335427340163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 16,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335516200163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 17,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335628735163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 18,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335732204163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 19,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335807660163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 20,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366335914661163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 21,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366336006804163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 22,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366336104159163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 23,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366336217194163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 24,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 366336330302163609 + wwv_flow_api.g_id_offset,
  p_region_id=> 366333716539163582 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 25,
  p_form_element_id=> null,
...
s:=s||'          ,DENSE_RANK() OVER (PARTITION BY COMPRA1.COMPCC_ID, COMPRA1.NUMERO_DOCUMENTO, COMPRA1.COMPRV_ID, COMPRA1.TIPO_DOCUMENTO'||unistr('\000a')||
'                                 ORDER BY COMPRA1.ID DESC) RANK'||unistr('\000a')||
'      FROM COM_PROVEEDORES_AUT_V COMPRA1'||unistr('\000a')||
'      WHERE COMPRA1.COMPRV_ID = :P251_ID'||unistr('\000a')||
'      AND COMPRA1.SITUACION NOT IN (''NUE'',''ANU'')'||unistr('\000a')||
'      AND COMPRA1.COMPRV_ID = :P251_ID'||unistr('\000a')||
'      AND COMPRA1.COMPCT_ID = :P251_';

s:=s||'COMPCT_ID) COMPRA'||unistr('\000a')||
'WHERE RANK = 1'||unistr('\000a')||
'and compra.situacion in (''VIG'',''MAR'')) compcc1'||unistr('\000a')||
'    ,COM_PROVEEDORES_CAR COMPCC2'||unistr('\000a')||
'WHERE COMPCC1.COMPCC_ID = COMPCC2.ID;'||unistr('\000a')||
'';

wwv_flow_api.create_report_region (
  p_id=> 367134221178421053 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 251,
  p_name=> 'Autoridades no presentadas TEST',
  p_region_name=>'',
  p_parent_plug_id=>366333716539163582 + wwv_flow_api.g_id_offset,
  p_template=> 142030053339227099+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 367134417136421126 + wwv_flow_api.g_id_offset,
  p_region_id=> 367134221178421053 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'NOMBRE',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 367134512031421142 + wwv_flow_api.g_id_offset,
  p_region_id=> 367134221178421053 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 367134621251421142 + wwv_flow_api.g_id_offset,
  p_region_id=> 367134221178421053 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 367134723768421142 + wwv_flow_api.g_id_offset,
  p_region_id=> 367134221178421053 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
begin
wwv_flow_api.create_page_item(
  p_id=>366344515250030493 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 251,
  p_name=>'P251_ENFOCAR_AUT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 390,
  p_item_plug_id => 35627219591806009+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
