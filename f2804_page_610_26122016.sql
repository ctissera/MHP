...
--   Date and Time:   12:49 Lunes Diciembre 26, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161222101627'
  );
null;
...
'  and comcon_pkg.comcon_comprv_ctzcnt(p_comcon_id => comcon.id, p_comprv_id => com';

s:=s||'coi.comprv_id) = 0'||unistr('\000a')||
''||unistr('\000a')||
...
s:=s||'ciones_v   comcon'||unistr('\000a')||
'where comcoi.situacion         = ''ACT'''||unistr('\000a')||
'  and comcoi.comcon_id         = comcon.id'||unistr('\000a')||
'  and comcon.fecha_publicacion <= sysdate'||unistr('\000a')||
'  and comcoi.comprv_id         = :P610_COMPRV_ID'||unistr('\000a')||
'  and comcon_pkg.comcon_comprv_estado(p_comcon_id => comcon.id, p_comprv_id => comcoi.comprv_id) = ''ABIERTO'''||unistr('\000a')||
'  and comcon_pkg.comcon_comprv_ctzcnt(p_comcon_id => comcon.id, p_comprv_id => comcoi.comprv_id) > 0';
...
'      , ''<a href="f?p=ADMCOM:891:&SESSION.::NO:891:P891_ID,P891_APP_ANTERIOR,P891_PAG_ANTERIOR:''||comcet.comocm_id||'',&APP_ID.,&APP_PAGE_ID."><font color="red">Vencimiento Entrega Orden: ''||comcet.comocm_codigo||''/''||comcet.COMPED_EJERCICIO||''</font></a>'' etiqueta'||unistr('\000a')||
'from   COM_COMPROBANTES_ENT2_V comcet'||unistr('\000a')||
'where  comcet.comprv_id = :P610_COMPRV_ID'||unistr('\000a')||
'and ';

s:=s||'   comcet.COMCEE_ESTADO not in (''NUE'',''ANU'') '||unistr('\000a')||
''||unistr('\000a')||
'union all'||unistr('\000a')||
''||unistr('\000a')||
'select trunc(comcon.fecha_fin_propuesta) fecha'||unistr('\000a')||
...
'from com_contrataciones_inv com';
...
'      ,''<a href="f?p=2102:200:&SE';

s:=s||'SSION.::NO:200:P200_COMCON_ID,G_APP_ANTERIOR,G_APP_ANTERIOR_PAG,P200_MUESTRO_MSJ_SN:''||comcon.id||'',&APP_ID.,&APP_PAGE_ID.,&P610_COMPRV_ID.,SI">Proceso en Análisis de Oferta: ''||comcon.codigo||''/''||comcon.comped_ejercicio||''</a>'' etiqueta'||unistr('\000a')||
'from com_contrataciones_inv comcoi'||unistr('\000a')||
'    ,com_contrataciones_v   comcon'||unistr('\000a')||
'where comcoi.situacion         = ''ACT'''||unistr('\000a')||
'  and comcoi.comcon_id         = comcon.id'||unistr('\000a')||
...
s:=s||'con.fecha_publicacion <= sysdate'||unistr('\000a')||
'  and comcoi.comprv_id         = :P610_COMPRV_ID'||unistr('\000a')||
'  and comcon_pkg.comcon_comprv_estado(p_comcon_id => comcon.id, p_comprv_id => comcoi.comprv_id) = ''EN ANALISIS'''||unistr('\000a')||
''||unistr('\000a')||
'union all'||unistr('\000a')||
''||unistr('\000a')||
'select trunc(comocm.fecha_ultima_entrega) fecha'||unistr('\000a')||
', ''<a href="f?p=COMCON:410:&SESSION.::NO:RP,410:P410_APP_ANTERIOR,P410_APP_ANTERIOR_PAG,P410_COMPRV_ID,P410_COMOCE_ESTADO,P410_FECHA_ENTREGA_DESD';

s:=s||'E,P410_FECHA_ENTREGA_HASTA:&APP_ID.,&APP_PAGE_ID.,&P610_COMPRV_ID.,APR,''||to_char(trunc(comocm.fecha_ultima_entrega),''DD/MM/YYYY'')||'',''||to_char(trunc(comocm.fecha_ultima_entrega),''DD/MM/YYYY'')||''">''||'||unistr('\000a')||
...
'--   , com_ordenes_compras_es';

s:=s||'t comoce'||unistr('\000a')||
...
''||unistr('\000a')||
'select trunc(sysdate) fecha'||unistr('\000a')||
'     , decode(cantidad,''0'','''',''<a href="f?p=COMCON:510:&SESSION.::NO:RP,510:P510_APP_ANTERIOR,P510_APP_ANTERIOR_PAG,P510_COMPRV_ID:&APP_ID.,&AP';

s:=s||'P_PAGE_ID.,&P610_COMPRV_ID."><font color="red">Ud. adeuda presentar ''||cantidad||'' documentos</font></a>'') etiqueta'||unistr('\000a')||
'from '||unistr('\000a')||
...
'  and comptt.comprt_id = (select comprt_id fro';

s:=s||'m com_proveedores comprv where comprv.id = :P610_COMPRV_ID)'||unistr('\000a')||
'  and com_pkg.obtn_comdoc_no_fmt2 ( p_segorg_id => COMPDT.SEGORG_ID'||unistr('\000a')||
'                                 , p_comprv_id => :P610_COMPRV_ID'||unistr('\000a')||
...
s:=s||'                                 , p_compde_estado => COMPDT.compde_estado) in (''NO PRESENTADO'',''VENCIDO'')'||unistr('\000a')||
''||unistr('\000a')||
'union all'||unistr('\000a')||
''||unistr('\000a')||
...
'from ('||unistr('\000a')||
'select distinct comode.comobj_codigo comobj_codigo'||unistr('\000a')||
...
s:=s||'e.COMOBJ_COMPRV_ID = :P610_COMPRV_ID'||unistr('\000a')||
...
'      , ''<a href="f?p=ADMCOM:PRVDET:&SESSION.::NO::P251_ID,P251_APP_ANTERIO';

s:=s||'R,P251_PAG_ANTERIOR:&P610_COMPRV_ID.,&APP_ID.,&APP_PAGE_ID.">Vencimiento de Cargo: ''||compra.compcc_nombre||'' - ''||compra.apellido||'' ''||compra.nombre||''</a>'' etiqueta'||unistr('\000a')||
...
'                     WHERE COMPRA1.SITUACION not in (''NU';

s:=s||'E'',''ANU'')'||unistr('\000a')||
