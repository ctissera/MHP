...
--   Date and Time:   12:16 Martes Noviembre 1, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161031155402'
  );
null;
...
s:=s||'omclf_id = comclf.ID'||unistr('\000a')||
'           AND comrep.comocm_id = comocm.ID'||unistr('\000a')||
'           AND comrep.estado IN (''PRE'', ''REP'')'||unistr('\000a')||
'           AND comoce.estado IN (''CON'', ''NOC'')'||unistr('\000a')||
'           AND comoce.fecha > (SYSDATE - 365)'||unistr('\000a')||
...
'           AND comrep.estado IN (''PRE'', ''REP'')'||unistr('\000a')||
'           AND comoce.estado IN (''CON'', ''NOC'')'||unistr('\000a')||
'           AND comoce.fecha > (SYSDAT';

s:=s||'E - 365)'||unistr('\000a')||
