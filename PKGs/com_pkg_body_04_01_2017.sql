...
--      ,SUM(nvl(comocm.monto,0)-nvl(comocm.monto_descuento,0)) AS MONTO_COP  --hubiera sido mejor hacerlo con esta linea y no con la anterior que vuelve a acceder a com_
FROM COM_ORDENES_COMPRAS       COMOCM
--    ,COM_ORDENES_COMPRAS_EST   COMOCE
    ,COM_PEDIDOS               COMPED
    ,COM_RUBCOB                COMRCB
