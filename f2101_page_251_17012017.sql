...
--   Date and Time:   13:06 Martes Enero 17, 2017
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20170117130557'
  );
null;
...
''||unistr('\000a')||
'and    comobd.ID = COMPRV_PKG.COMOBD_PRESENTADO_SN2(p_segorg_id => comobd.segorg_id --:P1_SEGORG_ID'||unistr('\000a')||
'                                        ,p_comodt_id => comobd.COMODT_ID'||unistr('\000a')||
'                                        ,p_comprv_i';

s:=s||'d => comobj.COMPRV_ID --:P251_ID'||unistr('\000a')||
