...
--   Date and Time:   08:41 Miércoles Diciembre 14, 2016
...
'No hay ayuda disponible para esta página.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20161214084049'
  );
null;
...
s:=s||'CHAR(COMCOB_V.PRECIO_UNITARIO,''999,999,999.99''))                PRECIO_UNITARIO_EDI'||unistr('\000a')||
...
s:=s||' COMCOB_V.COMPED_ID = :P309_COMPED_ID'||unistr('\000a')||
...
'     -- Verificar Cantidad en Blanco'||unistr('\000a')||
'     IF replace(htmldb_application.g_f02';

p:=p||'(i),''%''||''null%'',NULL) IS NULL THEN'||unistr('\000a')||
...
p:=p||''',''.''),''999999999999990.00'');'||unistr('\000a')||
...
'          v_mensaje := v_mensaje || ''Debe indicar u';

p:=p||'n valor numérico mayor a cero en la cantidad del detalle: ''|| i||''<br>'';'||unistr('\000a')||
'          v_compet_correcto := ''NO'';'||unistr('\000a')||
'       END IF;'||unistr('\000a')||
'     END IF;'||unistr('\000a')||
'    --'||unistr('\000a')||
...
'       v_compet_correcto := ''NO'';'||unistr('\000a')||
'       v_mensaje := v_mensaje ||''Debe indicar el Precio Nuevo para confirmar el detalle';
...
'       EXCEPTION'||unistr('\000a')||
'         WHEN OTHERS THEN'||unistr('\000a')||
'           v_mensaje := v_mensaje || ''Debe indicar un valor numérico en el precio de';

p:=p||'l detalle: ''|| i||''<br>'';'||unistr('\000a')||
'           v_compet_correcto := ''NO'';'||unistr('\000a')||
'       END;'||unistr('\000a')||
'     END IF;'||unistr('\000a')||
'    --'||unistr('\000a')||
...
p:=p||'mensaje := v_mensaje ||''Se ha actualizado ''||v_cantidad||'' detalle(s) con éxito.'';  '||unistr('\000a')||
'     END IF; '||unistr('\000a')||
...
'     IF replace(htmldb_application.g_f03(i),''%''||''null%'',NULL) IS NULL THEN'||unistr('\000a')||
'       v_compet_correcto := ''NO'';'||unistr('\000a')||
'       v_mensaje := v_mensaje ||''Debe indicar el Precio Nuevo para confirmar el';

p:=p||' detalle: ''|| i ||'||unistr('\000a')||
'                    ''<br>'';'||unistr('\000a')||
'     ELSE'||unistr('\000a')||
'       -- Verificar que la Precio sea numerico y de  2 decimales'||unistr('\000a')||
'       BEGIN'||unistr('\000a')||
...
'       EXCEPTION'||unistr('\000a')||
'         WHEN OTHERS THEN'||unistr('\000a')||
'           v_mensaje := v_mensaje || ''Debe indicar un valor numérico en el p';

p:=p||'recio del detalle: ''|| i||''<br>'';'||unistr('\000a')||
'           v_compet_correcto := ''NO'';'||unistr('\000a')||
'       END;'||unistr('\000a')||
'     END IF;'||unistr('\000a')||
'    --'||unistr('\000a')||
...
p:=p||' v_cantidad := v_cantidad + 1;'||unistr('\000a')||
'       --'||unistr('\000a')||
'      END IF;'||unistr('\000a')||
'    --'||unistr('\000a')||
'    END;'||unistr('\000a')||
...
p:=p||'      v_mensaje := v_mensaje ||''Se ha actualizado ''||v_cantidad||'' detalle(s) con éxito.'';  '||unistr('\000a')||
'     END IF; '||unistr('\000a')||
'     apex_application.g_print_success_message := v_mensaje||'||unistr('\000a')||
'     ''<br>Los detalles con error han sido restaurados con su información original.'';'||unistr('\000a')||
'  END IF;'||unistr('\000a')||
